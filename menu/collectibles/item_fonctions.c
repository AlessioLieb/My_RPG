...
int fly_player(player *py)
{
    ...
    if (py->change_texture == 1)
        sfSprite_setTexture(py->sp, sfTexture_createFromFile("assets/robin_fly.png", NULL), sfFalse);
    ...
    if (py->change_texture == 4)
        sfSprite_setTexture(py->sp, sfTexture_createFromFile("assets/oscar_fly.png", NULL), sfFalse);
    if (py->change_texture == 3)
        sfSprite_setTexture(py->sp, sfTexture_createFromFile("assets/alessio_fly.png", NULL), sfFalse);
    return 1;
}
