...
{
    sfTexture *t_greed = sfTexture_createFromFile("../Sprites/bosses/greed.png", NULL);
    sfTexture *text_dark = sfTexture_createFromFile("../Sprites/bosses/dark_one.png", NULL);
    sfTexture *t_husk = sfTexture_createFromFile("../Sprites/bosses/husk.png", NULL);
    sfVector2f scale = {3, 3};
...
{
    sfTexture *p = sfTexture_createFromFile("../Sprites/bosses/pit.png", NULL);
    sfTexture *l = sfTexture_createFromFile("../Sprites/bosses/loki.png", NULL);
...
{
    sfTexture *text_m = sfTexture_createFromFile("../Sprites/bosses/monstro.png", NULL);
    sfTexture *text_d = sfTexture_createFromFile("../Sprites/bosses/diggle.png", NULL);
